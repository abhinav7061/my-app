...
export const workExperience = [
  ...
  {
    id: 4,
    title: "PollLab Project Developer",
    desc: "Developed PollLab, a web-based polling system using the MERN stack, to facilitate seamless poll creation and management.",
    className: "md:col-span-2",
    thumbnail: "/exp4.svg",
  },
];
